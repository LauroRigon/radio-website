<template>
<div>
	<div class="row chat-window col-md-3 col-sm-4 col-md-offset-9">
        <div class="col-xs-12 col-md-12">
        	<div class="panel panel-default">
                ...
                <div class="panel-footer" v-show="!collapsed">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control input-sm chat_input" placeholder="Escreva seu pedido aqui..." v-model="message.content">
