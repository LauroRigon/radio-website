...
<div v-show="isVisible">
        ...
        <div class="col-4 pull-right">
            <div class="box box-solid" style="padding:5px">
                <div class="btn-group">
                	...
                	<a class="btn btn-danger dropdown-toggle" data-toggle="dropdown" @click="toggleDropdown()">Reprovar <i class="fa" :class="dropdownActive? 'fa-caret-up': 'fa-caret-down'"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" v-show="dropdownActive">
        <div class="form-group col-md-6 col-sm-8 col-xs-8 pull-right well" style="padding-top:2px">
			...
			<a class="btn btn-primary pull-right" style="margin-top: 5px" @click="sendDisapprove()" :disabled="sendingPost"><i class="fa fa-refresh fa-spin" v-show="sendingPost"></i> Concluir</a>
    	</div>
    </div>
